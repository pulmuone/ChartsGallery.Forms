...
namespace ChartsGallery.Forms.ViewModels {
    public class PointChartViewModel : ChartViewModelBase {
        ...
        LondonWeatherData chartData = new LondonWeatherData();

        public XYSeriesData NightMin => chartData.NightMin;
        public XYSeriesData DayMax => chartData.DayMax;
    ...
    public class BubbleChartViewModel : ChartViewModelBase {
        HighestGrossingFilmsByYearData seriesData = new HighestGrossingFilmsByYearData();

        public override string Title => "Highest-Grossing Films by Year";
        public HighestGrossingFilmsByYearData SeriesData => seriesData;
